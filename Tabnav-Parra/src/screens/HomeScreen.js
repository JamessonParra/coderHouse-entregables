...
function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>ENTREGABLE 5</Text>
      <TouchableOpacity onPress={() => navigation.push('Acerca de')} style={styles.card}>
        <Text style={styles.cardTitle}>Mí historia</Text>
        <Text style={styles.cardText}>Learn more about our team and our mission.</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.push('Contacto')} style={styles.card}>
